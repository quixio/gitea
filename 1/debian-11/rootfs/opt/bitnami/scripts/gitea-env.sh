...
export GITEA_MINIMUM_KEY_SIZE_CHECK="${GITEA_MINIMUM_KEY_SIZE_CHECK:-true}"
...
export GITEA_SHOW_REGISTRATION_BUTTON="${GITEA_SHOW_REGISTRATION_BUTTON:-false}"
export GITEA_REQUIRE_SIGNIN_VIEW="${GITEA_REQUIRE_SIGNIN_VIEW:-true}"
