...
export GITEA_QUEUE_CONN_STR="${GITEA_QUEUE_CONN_STR:-}"
export GITEA_QUEUE_TYPE="${GITEA_QUEUE_TYPE:-redis}"
export GITEA_ISSUE_INDEXER_TYPE="${GITEA_ISSUE_INDEXER_TYPE:-db}"
export GITEA_SESSION_PROVIDER="${GITEA_SESSION_PROVIDER:-db}"
